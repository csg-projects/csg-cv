...
\fbox{\includegraphics[width=2cm]{./img_csem.jpg}}%
}%
\end{minipage} 
\end{table}
...
& \footnotesize{Intern at the Embedded Software Division of the CSEM in Neuch\^atel, CH. I am working on a distributed streaming platform of medical data that leverages Trusted Execution Environments for performing computations on sensitive data.}
\end{tabular}
...
\begin{tabular}{R{1.5cm}|p{13.8cm}}	
    \textsc{03/2019} &  Bachelor`s degree in \textbf{\textsc{Telecommunications Science and Technology}}\\ 
    \textsc{09/2014} & \small{\emph{Polytechnic University of Catalonia}, UPC} \\
