...
\begin{tabular}{R{1.5cm}|p{13.8cm}}
    ...
    & \footnotesize{My main background and interests comprise distributed architectures and computing, cloud and serverless technologies and decentralized systems. I am familiar with diverse architectures in the High Performance Computing ecosystem.}  \\
\end{tabular}
