...
\begin{table}[ht]
    \begin{tabular}{L{1.75cm}p{3cm}p{1cm}L{1.4cm}L{1.5cm}L{0.5cm}L{1.5cm}L{3cm}}
        ...
        Birth year: & 1996 & & Spanish: & Native & & \multicolumn{2}{l}{Mathematics} \\
...
\begin{tabular}{p{\pageWidth}}
    ...
    I am willing to teach mathematics at any curricular level, and computer
...
\begin{tabular}{R{\leftColumnWidth}|p{\rightColumnWidth}}
    \textsc{Mathematics} & 
    Willing to teach any area of mathematics at any curricular level.
    
    \\
\end{tabular}

\begin{tabular}{R{\leftColumnWidth}|p{\rightColumnWidth}}
    \textsc{Computer Science} & Research Assistant at the \textbf{\textsc{Universit\'e de Neuch\^atel}} \\
\end{tabular}
