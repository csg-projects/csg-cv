...
\begin{tabular}{p{\dimexpr1.5cm+15.5cm}}
    \textit{(Submitted)} J. Neves, P. Gouveia, C. Segarra, L. Liechti, V. Schiavoni, and M. Matos, \textbf{\textit{"KOLLAPS: Decentralized and Dynamic Topology Emulation}}. A* Systems Conference (Anonymous Submission). \\[3pt]
...
\begin{tabular}{R{1.5cm}|p{\columnWidth}L{2cm}}	
    ...
    \textsc{09/2019} & \small{\emph{School of Mathematics and Statistics - Technical University of Catalonia}, UPC} & \\
     & \footnotesize{
         ...
         Relevant courses cover: Concurrency, Parallelism, and Distributed Systems, and Decentralized Systems.
