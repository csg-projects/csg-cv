...
\begin{tabular}{R{1.5cm}|p{\columnWidth}L{2cm}}
    \emph{Current} & Research Collaborator at the \textbf{\textsc{Technical University of Catalonia}} & \href{https://www.csem.ch/}{\XeTeXLinkBox{\includegraphics[width=1cm]{img/logoUPC.png}}}\\
...
\begin{tabular}{R{1.5cm}|p{\columnWidth}L{2cm}}
    \emph{Current} & Research Assistant at the \textbf{\textsc{Universit\'e de Neuch\^atel}} & \href{https://www.csem.ch/}{\XeTeXLinkBox{\includegraphics[height=0.5cm]{img/unine}}}\\
