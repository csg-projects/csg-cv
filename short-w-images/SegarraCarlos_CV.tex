...
\begin{tabular}{p{\dimexpr1.5cm+15.5cm}}
    ...
    \textit{J. Neves, P. Gouveia, C. Segarra, L. Liechti, V. Schiavoni, and M. Matos, \textbf{\textit{"KOLLAPS: Decentralized and Dynamic Topology Emulation}}. EuroSys'20. April 27-30, 2020.} \\[3pt]
...
\begin{tabular}{R{1.5cm}|p{\columnWidth}L{2cm}}
    \emph{12/2019} & Research Assistant at the \textbf{\textsc{Universit\'e de Neuch\^atel}} & \multirow{2}{*}{\href{https://www.unine.ch/iiun/home/chaires-de-recherche/systemes-complexes.html}{\XeTeXLinkBox{\includegraphics[width=2cm]{img/unine}}}}\\
...
\begin{tabular}{R{1.5cm}|p{\columnWidth}L{2cm}}	
    \textsc{11/2019} &  \textbf{\textsc{Kollaps: Decentralized and Dynamic Topology Emulator}}  & \multirow{2}{*}{\href{http://angainor.science/}{\XeTeXLinkBox{\includegraphics[width=1.5cm]{img/angainor.png}}}} \\ 
...
\begin{tabular}{R{1.5cm}|p{\columnWidth}L{2cm}}	
    \textsc{08/2019} &  \textbf{\textsc{MQT-TZ: Hardening MQTT Brokers Using Arm TrustZone}}  & \multirow{2}{*}{\href{https://github.com/mqttz}{\XeTeXLinkBox{\includegraphics[width=1.5cm]{img/mqttz.png}}}} \\ 
...
\begin{tabular}{R{1.5cm}|p{\columnWidth}L{2cm}}	
    \textsc{06/2018} &  \textbf{\textsc{DBSCAN for PyCOMPSs}} & \multirow{2}{*}{\href{https://github.com/bsc-wdc/compss}{\XeTeXLinkBox{\includegraphics[width=1.5cm]{img/compss.png}}}} \\  
